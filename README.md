...
* [`src/cljs/bishop/`](src/cljs/bishop/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/bishop/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `bishop` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/bishop/config.cljs) defaults to `true` in
...
```clj
(ns bishop.example
  (:require [bishop.config :as config])
